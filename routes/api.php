...
Route::get('resignemployees', [WebhookController::class, 'resignEmployees']);
Route::get('resignemployeessinter', [WebhookController::class, 'resignEmployeesSinter']);
Route::get('sentdata/{key1}/{key2}', [WebhookController::class, 'sentData']);
Route::get('deleteusermachine/{key1}', [WebhookController::class, 'deleteUserMachine']);
