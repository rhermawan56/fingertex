...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header border-0">
            <div class="card-title">
                <div class="card-title m-0">
                    <h3 class="fw-bolder m-0">{{ ucwords(request()->segment(3) . ' ' . ucwords(request()->segment(2))) }}
                    </h3>
                </div>
            </div>
        ...
        <div id="kt_account_profile_details" class="collapse show">
            <form id="kt_account_profile_details_form" class="form" method="POST" action="{{ route('machine.store') }}">
                @csrf
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="company" class="form-control form-control-sm form-control"
                                placeholder="PT KAHAPTEX" value="PT KAHAPTEX" />
                            @error('company')
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="msn_type" class="form-control form-control-sm form-control"
                                placeholder="Revo W-202BNC" value="{{ old('msn_type') }}" />
                            @error('msn_type')
                                <small class="text-danger">{{ '* ' . $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="cloud_id" class="form-control form-control-sm form-control"
                                placeholder="C263388123302938" value="{{ old('cloud_id') }}" />
                            @error('cloud_id')
                                <small class="text-danger">{{ '* ' . $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="msn_name" class="form-control form-control-sm form-control"
                                placeholder="HRD" value="{{ old('msn_name') }}" />
                            @error('msn_name')
                                <small class="text-danger">{{ '* ' . $message }}</small>
                            @enderror
                        </div>
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    ...
                    <button type="submit" class="btn btn-sm btn-primary" id="kt_account_profile_details_submit">Save
                        Changes</button>
                </div>
            </form>
        </div>
