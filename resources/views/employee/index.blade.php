            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    <div class="d-flex justify-content-end mx-1" data-kt-customer-table-toolbar="base">
                        <button type="button" onclick="syncdata(this)" class="btn btn-sm btn-primary text-center">
                            <span title="Synchronize Data" class="btn btn-sm svg-icon svg-icon-primary svg-icon-1hx p-0 m-0">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <a href="#" type="button" class="btn btn-primary pe-none d-none">Add
                            {{ ucwords(request()->segment(1)) }}</a>
                    </div>
